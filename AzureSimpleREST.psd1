@{
    ...
    GUID              = '52b2fee3-fc54-4b9a-ad52-4e382b194641'

    # Author of this module
    Author            = 'Fabian Bader'

    # Company or vendor of this module
    CompanyName       = 'https://github.com/f-bader'
    ...
    FunctionsToExport = @(
        ...
        'Get-AzSRRecoveryServiceVaultProtectedItem',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags         = 'Azure', 'REST', 'PSEdition_Desktop'

            # A URL to the license for this module.
            LicenseUri   = 'https://github.com/f-bader/AzureSimpleREST/blob/master/LICENSE'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/f-bader/AzureSimpleREST'
